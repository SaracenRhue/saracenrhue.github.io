...
The sys.args variable is a list in Python, which contains the command-line arguments passed to the script. The first item in this list is the name of the script. The list contains the rest of the arguments passed to the script.
